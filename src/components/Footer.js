  ...
  render() {
    return (
      <DivFooter>
        ...
        <div>
          <h4>
            © 2021 FutureNinja S.A. 49.999.120/0001-58 Rua Capote Valente, 09 -
            São Paulo, SP - 05409-000
          </h4>
        </div>
        <div>
          <h4>Como falar com a gente?</h4>
          <h4>(99) 4002-8922 </h4>
          <h4>Segunda à sexta das 8h às 21h, e aos Sábados das 8h às 16h.</h4>
          <h4>tenhointeresse@FutureNinja.com.br</h4>
          <h4>Respostas em até um dia útil</h4>
          <h4>imprensa@FutureNinja.com.br</h4>
        </div>
      </DivFooter>
    )
  }
